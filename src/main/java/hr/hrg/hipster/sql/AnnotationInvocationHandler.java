...
/**
	...
	https://github.com/leangen/geantyref/blob/master/src/main/java/io/leangen/geantyref/AnnotationInvocationHandler.java
	 - replaced: AnnotationFormatException with RuntimeException
 * 
 * An implementation of {@link Annotation} that mimics the behavior of normal annotations.
 * It is an {@link InvocationHandler}, meant to be used via {@link HipsterSqlUtil#annotation(Class, Map)} or {@link HipsterSqlUtil#annotation(Class, Object...)}.
 * <p>
 ...
 * without a default value, {@link RuntimeException} is thrown.
 * </p>
 * <p>
...
class AnnotationInvocationHandler implements Annotation, InvocationHandler, Serializable {
    ...
    AnnotationInvocationHandler(Class<? extends Annotation> annotationType, Map<String, Object> values) {
        ...
        if (annotationType.isAnnotation() && interfaces.length == 1 && interfaces[0] == Annotation.class) {
            ...
            throw new RuntimeException(annotationType.getName() + " is not an annotation type");
        }
    }
    ...
    static Map<String, Object> normalize(Class<? extends Annotation> annotationType, Map<String, Object> values)  {
        ...
        if (!missing.isEmpty()) {
            throw new RuntimeException("Missing value(s) for " + String.join(",", missing));
        }
        if (!invalid.isEmpty()) {
            throw new RuntimeException("Incompatible type(s) provided for " + String.join(",", invalid));
        }
        return valid;
    }
